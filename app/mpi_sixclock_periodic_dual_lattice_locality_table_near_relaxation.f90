program mpi_clock_dual_lattice_locality_simulation
  ...
  use gf2xe
  use msmt19937
  use sixclock_periodic_dual_lattice_locality_m
  use kahan_summation_m
  use variance_covariance_kahan_m
  use mpi_variance_covariance_kahan_m
  implicit none
  character(len=*), parameter :: version = "dual_lattice_locality_table_near"
...
end program mpi_clock_dual_lattice_locality_simulation
