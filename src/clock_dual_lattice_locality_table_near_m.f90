module sixclock_periodic_dual_lattice_locality_m
  use, intrinsic :: iso_fortran_env
  use msmt19937
  implicit none
  private
  character(len=*), parameter :: version = "dual_lattice_table_near"
...
end module sixclock_periodic_dual_lattice_locality_m
