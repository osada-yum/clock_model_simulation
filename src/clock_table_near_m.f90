module sixclock_periodic_table_near_m
  use, intrinsic :: iso_fortran_env
  use msmt19937
  implicit none
  private
  character(len=*), parameter :: version = "table_near"
...
contains
  ...
  impure subroutine local_flip(x, y, uy, dy)
...
end module sixclock_periodic_table_near_m
